...
public class CuzkApiFactoryFixture : IAsyncLifetime
{
    ...
    public CuzkApiFactory Factory { get; protected set; }

    public CuzkApiFactoryFixture()
    {
        Factory = new CuzkApiFactory(
