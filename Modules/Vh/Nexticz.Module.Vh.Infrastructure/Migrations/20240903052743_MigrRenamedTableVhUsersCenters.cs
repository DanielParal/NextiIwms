...
{
    /// <inheritdoc />
    public partial class MigrRenamedTableVhUsersCenters : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VhUsersCenters", x => new { x.CenterId, x.UserId });
                    table.ForeignKey(
                        name: "FK_VhUsersCenters_Centers_CenterId",
                        column: x => x.CenterId,
                        principalSchema: "Vh",
                    ...
                    table.ForeignKey(
                        name: "FK_VhUsersCenters_VhUsers_UserId",
                        column: x => x.UserId,
                        principalSchema: "Vh",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VhUsersCenters_UserId",
                schema: "Vh",
                table: "VhUsersCenters",
                column: "UserId");
        }
