...
namespace Nexticz.Module.Sign.Settings.Tests.Unit;

public class LayerDependencyTests
{
    private const string RootNamespace = "Nexticz.Module.Sign.Settings";
    ...
    private static readonly string RootPath = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "../../../../Nexticz.Module.Sign.Settings"));
