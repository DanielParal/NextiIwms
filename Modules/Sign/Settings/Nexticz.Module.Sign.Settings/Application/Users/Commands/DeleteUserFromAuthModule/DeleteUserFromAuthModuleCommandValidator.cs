...
internal class DeleteUserFromAuthModuleCommandValidator : AbstractValidator<DeleteUserFromAuthModuleCommand>
{
    public DeleteUserFromAuthModuleCommandValidator()
    {
