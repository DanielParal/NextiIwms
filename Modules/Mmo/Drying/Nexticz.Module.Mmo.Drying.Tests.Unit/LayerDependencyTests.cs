...
namespace Nexticz.Module.Mmo.Drying.Tests.Unit;

public class LayerDependencyTests
{
    private const string RootNamespace = "Nexticz.Module.Mmo.Drying";
    ...
    private static readonly string RootPath =
        Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, $"../../../../{RootNamespace}"));
